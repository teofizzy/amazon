...
### 4. Data Lake
Efficient data storage and management are critical components of this project. We will deploy a robust database system to store and organize the processed data, using amazon s3 to store them. As the size of our data increases, we need to ensure that our system scales with it. We shall use AWS to process the vast amounts of data that we shall be getting.
